...
async function createTicketChannel(interaction, ticketType) {
    ...
    try {
        ...
        const ticketEmbed = new EmbedBuilder()
            .setTitle('Static Ticket Support')
            .setDescription(`<a:unknown:1495084306781962432> **Explain your problem in full detail, please wait for a Static support team to review and answer.**\n\n**Ticket Type:** ${ticketCategories[ticketType]?.name || ticketType}\n**Created by:** ${user.toString()}\n**Claimed by:** Not yet claimed`)
            .setColor(0x2B017F);
